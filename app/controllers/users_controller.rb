class UsersController < ApplicationController
  ...
  def boards
    @boards = @user.boards.recent.page(params[:page]).per_page(20)
  end

  def ideas
    @ideas = @user.ideas.recent.page(params[:page]).per_page(20)
  end

  def votes
    @user_votes = @user.user_votes.page(params[:page]).per_page(20)
  end
